...
(function() {
  ...
  SCSim.Hud = (function() {
    ...
    Hud.prototype.setupEvents = function() {
      ...
      this.addEvent("trainUnitComplete", function(e) {
        ...
        return _this.units[unit.actorName] = unit;
      });
  ...
  TESTCMD = (function() {
    ...
    TESTCMD.select = function(name, c) {
      var _this = this;
      return function(x) {
        return (c.call(_this))(x[name]);
      };
    };

    TESTCMD.andSay = function(msg) {
      var _this = this;
  ...
  SCSim.Cmd = (function() {
    ...
    Cmd.prototype.selectUnit = function(name, cont) {
      return function(hud) {
        return hud.units[name];
      };
    };
